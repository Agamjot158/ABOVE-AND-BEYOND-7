...
mongoose.connect('mongodb+srv://agamjot4833be21:4itrLHWOtuYtbWhV@cluster0.bgvnkpo.mongodb.net/mydb', {useNewUrlParser: true, useUnifiedTopology: true });
...
const Model = mongoose.model('STRIPPER', schema);
